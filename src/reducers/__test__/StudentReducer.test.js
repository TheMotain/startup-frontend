...
describe("StudentReducer.js", () => {
    ...
    test("When Action ADD_MALUS_PENDING", () => {
        let initialValue = {
            updateStatus: {
                updating: false
            }
        ...
        let actual = studentReducer(initialValue, {
            type: "ADD_MALUS_PENDING"
        });

        expect(actual).toEqual(expected);
    });

    test("When Action ADD_MALUS_FULFILLED", () => {
        let initialValue = {
            updateStatus: {
                updating: true,
                updated: false
    ...
    test("When Action ADD_MALUS_REJECTED", () => {
        let initialValue = {
            updateStatus: {
                updating: false,
                updateError: null
