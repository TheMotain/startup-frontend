 ...
 * @returns {boolean}
 */
export function specialContains(str1: string, str2: string) {
    if(typeof str1 !== "string" || typeof str2 !== "string") throw new Error("Les deux entrées doivent être des chaines de caractère");

    let str1Clean = removeDiacritics(str1.toLowerCase());
    let str2Clean = removeDiacritics(str2.toLowerCase());
